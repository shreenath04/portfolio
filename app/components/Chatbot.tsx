...
export default function Chatbot() {
  ...
  return (
    <>
      {/* 1. CHAT WINDOW: Now uses opacity, scale, and translate to smoothly animate in and out */}
      <div 
        className={`fixed bottom-20 right-4 sm:bottom-24 sm:right-6 z-50 flex flex-col border border-neutral-300 dark:border-neutral-800 rounded-lg bg-white dark:bg-neutral-900 shadow-xl overflow-hidden transition-all duration-300 ease-out origin-bottom-right
        ${isOpen 
      ...
      {/* 2. FLOATING BUTTON: Also animates in and out inversely to the chat window */}
      <button
        onClick={() => setIsOpen(true)}
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 px-5 py-3 rounded-full text-sm font-medium text-white bg-gradient-to-br from-neutral-800 to-neutral-600 shadow-lg hover:shadow-xl transition-all duration-300 ease-out origin-center
        ${isOpen 
