    ...
    <main className="flex-1">
      ...
      <section className="px-6 py-12 max-w-3xl mx-auto">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {experiences.map((exp) => (
            <div key={exp.title} className="min-w-[260px] border border-neutral-400 dark:border-neutral-800 rounded-lg p-5">
              ...
              <p className="text-xs text-neutral-700 dark:text-neutral-500 leading-relaxed">{exp.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-6 py-12 max-w-3xl mx-auto">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {projects.map((proj) => (
            <div key={proj.title} className="min-w-[260px] border border-neutral-400 dark:border-neutral-800 rounded-lg p-5">
              ...
              <p className="text-xs text-neutral-700 dark:text-neutral-500 leading-relaxed">{proj.desc}</p>
            </div>
          ))}
        </div>
        <a href="https://github.com/yourusername" target="_blank" className="inline-block mt-4 text-xs text-neutral-600 dark:text-neutral-400 border-b border-neutral-400 dark:border-neutral-600 pb-0.5 hover:opacity-70 transition-opacity">
          View all on GitHub →
        </a>
      </section>
      ...
      <section id="contact" className="px-6 py-12 max-w-3xl mx-auto">
        ...
        <div className="flex gap-6 pt-4 border-t border-neutral-400 dark:border-neutral-800">
          <a href="mailto:your@email.com" className="text-xs text-neutral-600 dark:text-neutral-400 hover:opacity-70 transition-opacity">Email</a>
          <a href="https://linkedin.com/in/yourprofile" target="_blank" className="text-xs text-neutral-600 dark:text-neutral-400 hover:opacity-70 transition-opacity">LinkedIn</a>
          <a href="https://github.com/yourusername" target="_blank" className="text-xs text-neutral-600 dark:text-neutral-400 hover:opacity-70 transition-opacity">GitHub</a>
        </div>
      </section>

      {/* Footer */}
      <footer className="px-6 py-6 border-t border-neutral-400 dark:border-neutral-800 text-center">
